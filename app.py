...
def preprocess_input_data(input_data_dict):
    ...
    #Drop original categorical, text, and date columns (that were replaced by features or dropped from X_train)
    ...
    #Align columns with the training data (model_features)
...
with st.form("ticket_form"):
    ...
    with col2:
        ...
        ticket_description = st.text_area("Ticket Description", 
                                          "Eg: My device is not turning on. It's urgent, I need help immediately!", 
